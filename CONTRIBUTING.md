...
Tracked product code and contracts live under `src/`. The root `foreman` executable is generated by `scripts/install.sh`, is ignored by Git, and must not be edited or committed. Generate or refresh it with:
